...
public class Empleado extends Persona
{
     ...
     */
    Empleado(int p_dni, String p_apellido, String p_nombre, int p_anio, long p_cuil, double p_importe){
     ...
     * @param p_anio el anio de ingreso a la compania del Empleado
     */
    Empleado(int p_dni, String p_apellido, String p_nombre, Calendar p_fecha, long p_cuil, double p_importe){
